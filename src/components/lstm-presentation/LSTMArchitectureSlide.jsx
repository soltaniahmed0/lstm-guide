    ...
    <div className="slide lstm-architecture-slide">
      ...
      <div className="schema-container-wrapper">
        ...
        <div className="lstm-cell-container" ref={containerRef} id="lstm-cell">
          ...
          <div className="weight-label" id="weight-W-f">W_f</div>
          <div className="weight-label" id="weight-U-f">U_f</div>
          ...
          <div className="weight-label" id="weight-W-i">W_i</div>
          <div className="weight-label" id="weight-U-i">U_i</div>
          ...
          {/* Candidate */}
          <div className="weight-label" id="weight-W-c">W_c</div>
          <div className="weight-label" id="weight-U-c">U_c</div>
          ...
          <div className="weight-label" id="weight-W-o">W_o</div>
          <div className="weight-label" id="weight-U-o">U_o</div>
